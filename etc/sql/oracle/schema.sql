...
CREATE TABLE ROLES (
    ...
    CONSTRAINT ROLES_ROLE_NN CHECK (ROLE IS NOT NULL),
    CONSTRAINT ROLES_CREATED_NN CHECK (CREATED_AT IS NOT NULL),
    CONSTRAINT ROLES_UPDATED_NN CHECK (UPDATED_AT IS NOT NULL)
);

-- 78 ) ========================================= ACCOUNT_ROLE_MAP table ===================================
...
CREATE TABLE ACCOUNT_ROLE_MAP (
    ...
    UPDATED_AT DATE,
    CREATED_AT DATE,
    CONSTRAINT ACCOUNT_ROLE_MAP_PK PRIMARY KEY (ACCOUNT, ROLE),
    CONSTRAINT ACCOUNT_ROLE_MAP_ACCOUNT_FK FOREIGN KEY (ACCOUNT) REFERENCES ACCOUNTS (ACCOUNT),
    CONSTRAINT ACCOUNT_ROLE_MAP_ROLE_FK FOREIGN KEY (ROLE) REFERENCES ROLES (ROLE),
    CONSTRAINT ACCOUNT_ROLE_MAP_ACCOUNT_NN CHECK (ACCOUNT IS NOT NULL),
    CONSTRAINT ACCOUNT_ROLE_MAP_ROLE_NN CHECK (ROLE IS NOT NULL),
    CONSTRAINT ACCOUNT_ROLE_MAP_LOCKED_NN CHECK (LOCKED IS NOT NULL),
    CONSTRAINT ACCOUNT_ROLE_MAP_CREATED_NN CHECK (CREATED_AT IS NOT NULL),
    CONSTRAINT ACCOUNT_ROLE_MAP_UPDATED_NN CHECK (UPDATED_AT IS NOT NULL)
);

-- 79 ) ========================================= ROLE_PERMISSION_MAP table ===================================
...
CREATE TABLE ROLE_PERMISSION_MAP (
    ...
    UPDATED_AT DATE,
    CREATED_AT DATE,
    CONSTRAINT ROLE_PERMISSION_MAP_PK PRIMARY KEY (ROLE, SCOPE, OPERATION),
    CONSTRAINT ROLE_PERMISSION_MAP_ROLE_FK FOREIGN KEY (ROLE) REFERENCES ROLES (ROLE),
    CONSTRAINT ROLE_PERMISSION_MAP_SCOPE_FK FOREIGN KEY (SCOPE) REFERENCES SCOPES (SCOPE),
    CONSTRAINT ROLE_PERMISSION_MAP_ROLE_NN CHECK (ROLE IS NOT NULL),
    CONSTRAINT ROLE_PERMISSION_MAP_SCOPE_NN CHECK (SCOPE IS NOT NULL),
    CONSTRAINT ROLE_PERMISSION_MAP_OPERATION_NN CHECK (OPERATION IS NOT NULL),
    CONSTRAINT ROLE_PERMISSION_MAP_CREATED_NN CHECK (CREATED_AT IS NOT NULL),
    CONSTRAINT ROLE_PERMISSION_MAP_UPDATED_NN CHECK (UPDATED_AT IS NOT NULL),
    CONSTRAINT ROLE_PERMISSION_MAP_OPERATION_CHK CHECK (OPERATION IN ('read', 'write'))
);
